package com.projectbasename.application.security.verification

import com.projectbasename.application.dto.auth.SmsVerificationResponse
import com.projectbasename.application.dto.auth.SmsVerificationResult
import com.projectbasename.domain.exception.BusinessException
import com.projectbasename.domain.exception.ExceptionType
import com.projectbasename.domain.service.SmsService
...
class SmsCodeService(
    ...
    fun generateAndSendCode(phone: String): SmsVerificationResponse {
        try {
            ...
            if (activeProfile.contains("dev")) {
                log.info("== // == // == CÓDIGO SMS PARA DESENVOLVIMENTO: $code (Telefone: ${maskPhone(cleanPhone)}) == // == // == ")
            }
    ...
    private fun generateSixDigitCode(): String {
        // Em desenvolvimento, usa código fixo para facilitar testes
        return if (activeProfile.contains("dev")) {
            "123456"
        } else {
