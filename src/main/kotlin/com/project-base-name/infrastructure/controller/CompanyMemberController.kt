...
import com.projectbasename.domain.service.CompanyMemberService
...
class CompanyMemberController(
    ...
    @GetMapping
    @PreAuthorize("@permissionService.hasAdminRole(authentication) or @companySecurityService.canAccessCompany(authentication, #companyId)")
    ...
    @PostMapping
    @PreAuthorize("@permissionService.hasCompanyAdminAccess(authentication, #companyId)")
    fun addMember(
        @Parameter(description = "ID da empresa")
        @PathVariable companyId: Long,
